...
int ws_parse_frame(const uint8_t *data, size_t len, WsFrame *out, bool require_mask = true, bool allow_rsv = false);
...
size_t ws_echo_frames_into_buffer(uint8_t *out_buf, size_t out_cap, uint8_t *data, size_t data_len, EchoResult &result);
