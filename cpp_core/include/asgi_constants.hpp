...
inline PyObject *get_cached_status(int code) {
    switch (code) {
    case 200:
        Py_INCREF(g_status_200);
        return g_status_200;
    case 201:
        Py_INCREF(g_status_201);
        return g_status_201;
    case 204:
        Py_INCREF(g_status_204);
        return g_status_204;
    case 301:
        Py_INCREF(g_status_301);
        return g_status_301;
    case 400:
        Py_INCREF(g_status_400);
        return g_status_400;
    case 404:
        Py_INCREF(g_status_404);
        return g_status_404;
    case 422:
        Py_INCREF(g_status_422);
        return g_status_422;
    case 500:
        Py_INCREF(g_status_500);
        return g_status_500;
    default:
