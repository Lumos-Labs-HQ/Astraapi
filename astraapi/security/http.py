...
from astraapi.openapi.models import HTTPBase as HTTPBaseModel
from astraapi.openapi.models import HTTPBearer as HTTPBearerModel
...
from astraapi._status import HTTP_401_UNAUTHORIZED, HTTP_403_FORBIDDEN

try:
    from astraapi._core_bridge import extract_bearer_token, extract_basic_credentials
...
class HTTPBasicCredentials(BaseModel):
    ...
    [AstraAPI docs for HTTP Basic Auth](https://astraapi.tiangolo.com/advanced/security/http-basic-auth/).
    """
...
class HTTPDigest(HTTPBase):
    ...
    **Warning**: this is only a stub to connect the components with OpenAPI in AstraAPI,
    ...
    from astraapi import Depends, AstraAPI
    from astraapi.security import HTTPAuthorizationCredentials, HTTPDigest
