...
from astraapi._compat.v2 import (
    get_flat_models_from_fields,
    get_model_name_map,
)
from astraapi.datastructures import DefaultPlaceholder
...
from astraapi.openapi.constants import METHODS_WITH_BODY, REF_PREFIX
from astraapi.params import Body, ParamTypes
from astraapi.responses import Response
from astraapi.types import ModelNameMap
from astraapi.utils import (
    deep_dict_update,
    is_body_allowed_for_status_code,
)
from pydantic import BaseModel
from astraapi._response import JSONResponse
...
def get_openapi_security_definitions(
    ...
    # Use dicts for ordered scope dedup (preserves insertion order)
    operation_security_sets: dict[str, dict[str, None]] = {}
    for security_dependency in flat_dependant._security_dependencies:
        ...
        if security_name not in operation_security_sets:
            operation_security_sets[security_name] = {}
        for scope in security_dependency.oauth_scopes or []:
            operation_security_sets[security_name][scope] = None
    operation_security = [
