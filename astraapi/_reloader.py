...
_RELOAD_WORKER_ENV = "_ASTRAAPI_RELOAD_WORKER"
...
def _spawn_worker(
    ...
    The worker runs with _ASTRAAPI_RELOAD_WORKER=1 set, which causes
...
def run_with_reload(
    ...
    1. Spawns a worker subprocess (same script, with _ASTRAAPI_RELOAD_WORKER=1)
