...
from astraapi.datastructures import DefaultPlaceholder, DefaultType
...
_invalid_args_message = (
    ...
    "https://astraapi.tiangolo.com/tutorial/response-model/"
)
...
def create_model_field(
    ...
    try:
        ...
        raise astraapi.exceptions.AstraAPIError(
