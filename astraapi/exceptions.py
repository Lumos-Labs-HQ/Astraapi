    ...
    def __init__(
        ...
        status_code: Annotated[
            ...
            Doc(
                ...
                Read more about it in the
                [AstraAPI docs for Handling Errors](https://astraapi.tiangolo.com/tutorial/handling-errors/#use-httpexception)
                """
            ),
        ],
        detail: Annotated[
        ...
        headers: Annotated[
            ...
            Doc(
                ...
                Read more about it in the
                [AstraAPI docs for Handling Errors](https://astraapi.tiangolo.com/tutorial/handling-errors/#add-custom-headers)
...
class AstraAPIError(RuntimeError):
    """
    A generic, AstraAPI-specific error.
    """


class DependencyScopeError(AstraAPIError):
    """
...
class PydanticV1NotSupportedError(AstraAPIError):
    """
    A pydantic.v1 model is used, which is no longer supported.
    """


class AstraAPIDeprecationWarning(UserWarning):
    """
