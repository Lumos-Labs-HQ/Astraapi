...
from astraapi._status import WS_1008_POLICY_VIOLATION
from astraapi.exceptions import HTTPException, RequestValidationError, WebSocketRequestValidationError
from astraapi.websockets import WebSocket


def _is_body_allowed_for_status_code(status_code):
    """Inline copy to avoid importing astraapi.utils (which triggers pydantic)."""
