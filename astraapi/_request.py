...
Implements the full ASGI request API surface used by AstraAPI routing and
dependency injection, with zero starlette imports.
"""
from __future__ import annotations

from astraapi._json_utils import json_loads as _json_loads
    ...
    async def form(self, *, max_files: int = 1000, max_fields: int = 1000) -> Any:
        ...
        if self._form is None:
            ...
            if "multipart/form-data" in content_type:
                try:
                    from astraapi._core_bridge import parse_multipart_body
                ...
                try:
                    from astraapi._core_bridge import parse_urlencoded_body
